...
function AppNavbar({ toggleSidebar }) {
  ...
  const { getPositionData, positionData } = usePosition();
  ...
  const fetchData = useCallback(async () => {
    setIsLoading(true);
    try {
      if (authdata.publicEmployeeId != null) {
  ...
  }, [getEmployeeById, getPositionData, authdata]);
  ...
  const avatarUrl = employeeHaveImageFile
    ...
    // const titleName = titleDropdown.find((item) => item.value === employeeById.titleId)?.label ?? "คุณ"
  return (
    <>
      <div>
              ...
              >
                {loading ? (
                  <>
                    ...
                    <div className="muted text-center">กำลังโหลด...</div>
                  </>
                ) : (
                  <>
                    {authdata.publicEmployeeId ? (
                      ...
                      {authdata.publicEmployeeId ? (
                        <>
                          <div className="profile-content">
                            ...
                            >
                              <p className="position-content text-secondary">
