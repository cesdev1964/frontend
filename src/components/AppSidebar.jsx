...
function AppSidebar({ isOpen, toggleSidebar, asideRef }) {
  ...
  const employeeId = authdata?.publicEmployeeId;
        ...
        <ul className="nav">
                      ...
                      <NavLink
                        to={{
                          ...
                          search: `?startDate=${getDateOnly(
                            currentDate
                          )}&endDate=${getDateOnly(currentDate)}`,
                        }}
                        className="nav-link dropdown-link"
                      >
                        <span className="icon">
          ...
          <li className="dropdown-container">
            ...
            <ul className={`submenu ${isReportOpen ? "show" : ""}`}>
              ...
              <li>
                <NavLink
                  to="/reports/specialdailywagereport"
                  className="nav-link dropdown-link"
                >
                  <span className="icon">
                    <i className="bi bi-folder-fill"></i>
          ...
          {//   rolePermissionRequire.some((p) =>
          //   [PermissionEnum.SETTING].includes(p)
          // ) ||
          //   roleRequire.some((r) => [RoleEnum.SUPER].includes(r))
          CheckPermission([PermissionEnum.SETTING]) && (
            <>
              <li>
                <NavLink
                  to="/settings"
