...
export default function CopperImage({
  madalName,
  src,
  setPreview,
  show,
  ...
  return (
    <>
      ...
      <Modal
        ...
        onHide={handleClose}
        animation={false}
        style={{ zIndex: 2000 ,borderRadius:"20px"}}
        backdrop="static"
